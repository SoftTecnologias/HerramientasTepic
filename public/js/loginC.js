...
$(function () {
  $('#btnLogin').on('click',function(){
      $.ajax({
          url:document.location.protocol+'//'+document.location.host + '/HerramientasTepic/public' + "/usuario/login",
          type:"POST",
          data:{
              email: $("#email").val(),
            ...
            if(response.code == 200){
                ...
                window.location.reload();
                    ...
                    if(response.code == 403) {
                        ...
                        window.location = document.location.protocol + '//' + document.location.host + '/HerramientasTepic/public' +"/area";
                    }else {
