...
$(function () {
    $("#btnRemover").on("click",function(){
        ...
        $.ajax({
            url: document.location.protocol + '//' + document.location.host + '/HerramientasTepic/public' + '/user/cart/removeToCart',
            type: 'delete',
            data: {
    ...
    swal({
        ...
        preConfirm: function (cantidad) {
            ...
            return new Promise(function (resolve, reject) {
                $.ajax({
                    url: document.location.protocol+'//'+document.location.host + '/HerramientasTepic/public' + '/user/cart/add', /*quitar o agregar segun corresponda*/
                    type: 'POST',
                    data: {
                        id: id,
                        cantidad: cantidad
