    ...
    var tabla= $('#tblServicios').DataTable({
        ...
        columns: [
            ...
            {data: function (row) {
                ...
                str = "<div align='center'>";
                str +=" <button id='btnEditar' class='btn btn-primary btn-xs col-md-5' onclick='showService("
                ...
                str += "<button id='btnEliminar' class='btn btn-danger btn-xs col-md-5'" +
...
function verMiniatura(id) {
   ...
   if($('#check').prop('checked')){
       texto1 = 'El Servicio será visible en el pie de pagina';
   }else{
       texto1 = 'El Servicio no será visible en el pie de pagina';
   }
    swal({
        title: '¿Estás seguro?',
        text: texto1,
