...
$(function(){
    ...
    $('#subcategoryTable').DataTable({
        "processing": true,
        "serverSide": true,
        'ajax': document.location.protocol+'//'+document.location.host+'/HerramientasTepic/public'+'/area/resource/subcategorias',
        'columns':[
            {
                data:'name'
            },{
...
function newSubcategory(){
 ...
 var catid = $('#categoryid').val()
    $.ajax({
     url:document.location.protocol+'//'+document.location.host+'/HerramientasTepic/public'+'/area/resource/subcategorias',
     type:'POST',
...
function updateSubcategory(id){
    ...
    $.ajax({
        url:document.location.protocol+'//'+document.location.host+'/HerramientasTepic/public'+"/area/resource/subcategorias/"+id,
        type:"PUT",
        data:{
            name: $("#name").val(),
...
function deleteSubcategory(id){
    ...
    swal({
        ...
        ruta =document.location.protocol+'//'+document.location.host+'/HerramientasTepic/public'+'/area/resource/subcategorias/'+id;
        $.ajax({
            url:ruta,
            type:'delete',
            headers: {
