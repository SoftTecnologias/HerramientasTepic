...
<footer id="footer">
    <div class="container">
        <div class="col-md-3 col-sm-6">
            ...
            <h4>Inscríbete a nuestro Boletin mensual</h4>
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <a href="{{route('area.index')}}" class="btn btn-small btn-template-main">Ir a la parte administrativa</a>
...
<div id="copyright">
    <div class="container">
        <div class="col-md-12">
            <p class="pull-left">&copy; 2017. Herramientas y Servicios de Tepic</p>
            <p class="pull-right">Template by <a href="https://bootstrapious.com">Bootstrapious</a> & <a
                        href="https://remoteplease.com">Remote Please</a>
