...
<div id="mailsub" class="notification" align="center">
    ...
    pero antes te pedimos actives tu cuenta pulsando el siguiente botón
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <div style="line-height: 24px;">
                                                        <button style = " background-color: #00a65a;
                                                                          border-color: #008d4c;
                                                                         "
                                                           href="{{route('tienda.confirmar',['id'=> base64_encode($user->id)])}}">
                                                            Activar mi cuenta </button>
                                                    </div>
                                                    <!-- padding -->
                                                    <br>
                                                    <hr>
                                ...
                                <tr>
                                    <td class="iage_footer" align="center" bgcolor="#ffffff">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center"
                                                    style="padding:20px;flaot:left;width:100%; text-align:center;">
                                                    <font face="Arial, Helvetica, sans-serif" size="3" color="#96a5b5"
                                                          style="font-size: 13px;">
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
                        2017 © Herramientas y Servicios de Tepic todos los derechos reservados.
				</span></font>
                                                </td>
                                            </tr>
                                        </table>
